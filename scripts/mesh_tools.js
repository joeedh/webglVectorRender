...
define([
  ...
  var findnearest_handle = exports.findnearest_handle = function findnearest_handle(mesh, mpos, limit) {
    limit = limit === undefined ? DEFAULT_LIMIT : limit;
  ...
  var findnearest = exports.findnearest = function findnearest(mesh, mpos, typemask, limit) {
    ...
    if (typemask & MeshTypes.HANDLE) {
      domin(exports.findnearest_handle(mesh, mpos));
    }
  ...
  exports.CreateFaceOp = class CreateFaceOp extends toolsys.ToolOp {
    constructor() {
      super();
    }
    
    exec(ctx) {
      console.log("Make face op");
      ...
      for (let v of mesh.verts) {
        ...
        do {
          ...
          for (let e of v.edges) {
            ...
            if (!vset.has(v2) && (v2.flag & MeshFlags.SELECT)) {
              ok = true;
              v = v2;
              break;
            }
